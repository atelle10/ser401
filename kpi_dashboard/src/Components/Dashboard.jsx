...
// Advanced components (from 560 — keep them for richer dev experience)
...
// Mock data for development (safe to keep until real backend data is ready)
...
const Dashboard = ({ role }) => {
  ...
  return (
    <div className="p-2 sm:p-4 space-y-4 sm:space-y-6">
      {/* Basic KPIs — always visible to all authenticated roles */}
      ...
      {canViewAdvanced && (
        <div className="mt-8">
          <h2 className="text-2 constitute-xl font-bold mb-4">Advanced Analytics</h2>
      ...
      {/* Optional message for viewer role */}
      {role === "viewer" && (

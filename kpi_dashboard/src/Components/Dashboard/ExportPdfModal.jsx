          ...
          <div className="space-y-1">
            ...
            <div className="relative">
              <select
                ...
                className="w-full appearance-none rounded-lg border border-blue-700 bg-blue-950 px-3 py-2 pr-10 text-sm text-white"
              >
              ...
              <svg
                className="pointer-events-none absolute right-3 top-1/2 h-4 w-4 -translate-y-1/2 text-blue-200"
                viewBox="0 0 20 20"
                fill="currentColor"
                aria-hidden="true"
              >

...
const Logo = () => {
  return (
    <div className="grid grid-cols-1 p-1.5 text-xs items-center cursor-pointer shrink rounded-2xl justify-center bg-white shadow-blue-500/20 shadow-md w-fit h-fit">
        <img src="./src/Components/assets/Famar Logo.png" alt="Famar Logo" className='mx-auto object-center w-13 h-13 transition-all duration-500 ease-in-out hover:-translate-y-1 hover:scale-110'/>
